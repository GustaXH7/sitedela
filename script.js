...
function updateCounter() {
    ...
    if (diff < 0) {
        ...
        document.querySelector('#contador h2').textContent = 'Faltam para o Nosso Primeiro Mês';
        document.getElementById('contador-mensagem').textContent = 'Mal posso esperar para celebrarmos nosso primeiro mês juntos! 💕';
    ...
    document.querySelector('#contador h2').textContent = 'Nosso Tempo Juntos';
    document.getElementById('contador-mensagem').textContent = 'E cada segundo ao seu lado vale uma eternidade!';
